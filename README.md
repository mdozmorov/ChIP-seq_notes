...
- [SCREEN](https://screen.wenglab.org/) - ENCODE4 registry of cis-regulatory elements database, expanded using STARR-seq, reporter assays, CRISPS, transgenic mouse assays. 2,373,014 human cCREs and 926,843 mouse cCREs, covering 21% of the human and 9% of the mouse genomes, annotated with potential functions. Eight categories based on distance to annotated transcription start sites (TSSs) and combinations of biochemical signals. Includes silencers (REST motifs), two categories: enhancer/silencer and pure silencer. MAFF and MAFK dynamic enhancers. [Supplementary data](https://users.moore-lab.org/ENCODE-cCREs/Supplementary-Data/). GitHub: [SCREEN2.0](https://github.com/weng-lab/SCREEN2.0), [VESPA](https://github.com/Moore-Lab-UMass/VESPA), [ENCODE4](https://github.com/weng-lab/ENCODE-cCREs/tree/master/Version-4). <details>
    <summary>Paper</summary>
    Moore, Jill E., Henry E. Pratt, Kaili Fan, et al. “An Expanded Registry of Candidate Cis-Regulatory Elements.” Nature, ahead of print, January 7, 2026. https://doi.org/10.1038/s41586-025-09909-9.
</details>
